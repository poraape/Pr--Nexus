...
// .wrangler/tmp/bundle-52iCHs/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-52iCHs/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../packages/agents/src/a0-planner/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
var EventHeaderSchema = external_exports.object({
...
var createEventMessage = /* @__PURE__ */ __name((name, headers, payload, version2 = 1) => ({
  name,
  headers,
  payload,
  version: version2
}), "createEventMessage");
var isEventMessage = /* @__PURE__ */ __name((value) => {
  if (typeof value !== "object" || value === null) return false;
  const candidate = value;
  return typeof candidate.name === "string" && candidate.name in EVENT_TOPIC && typeof candidate.headers === "object" && candidate.headers !== null && typeof candidate.headers.traceId === "string";
}, "isEventMessage");
var QUEUE_BINDING_BY_TOPIC = {
...
var DocumentSchema = external_exports.object({
  ...
  source: external_exports.enum(["upload", "api", "backfill", "sync"]).default("upload"),
  kind: external_exports.enum(["NFE_XML", "CSV", "XLSX", "PDF", "IMAGE", "UNSUPPORTED"]),
  name: nonEmptyString,
  sizeBytes: external_exports.number().int().nonnegative(),
  checksum: nonEmptyString.optional(),
  uploadedAt: isoDateTime,
  status: external_exports.enum(["parsed", "ocr_needed", "unsupported", "error"]),
  storageUrl: external_exports.string().url().optional(),
  encoding: external_exports.string().optional(),
  meta: external_exports.object({
    sourceZip: external_exports.string().optional(),
    internalPath: external_exports.string().optional(),
    tags: external_exports.array(external_exports.string()).optional()
  }).optional(),
  data: external_exports.array(external_exports.record(nonEmptyString, RecordDataValue)).optional(),
  text: external_exports.string().optional(),
  error: external_exports.string().optional()
});
var DocumentJsonSchema = zodToJsonSchema(DocumentSchema, "Document");
var ParsedDocumentSchema = external_exports.object({
  doc: DocumentSchema,
  parsedAt: isoDateTime,
  parserVersion: nonEmptyString,
  ocrApplied: external_exports.boolean().default(false),
  normalizedText: external_exports.string().optional(),
  structuredData: external_exports.array(
    external_exports.object({
      lineId: nonEmptyString,
      values: external_exports.record(nonEmptyString, RecordDataValue),
...
var ParsedDocumentJsonSchema = zodToJsonSchema(ParsedDocumentSchema, "ParsedDocument");
var NormalizedLineSchema = external_exports.object({
  lineId: nonEmptyString,
  docId: nonEmptyString,
...
var NormalizedDocumentSchema = external_exports.object({
  doc: DocumentSchema,
  lines: external_exports.array(NormalizedLineSchema),
  normalizationVersion: nonEmptyString,
  normalizedAt: isoDateTime,
  unitSystem: external_exports.enum(["metric", "imperial"]).default("metric"),
  currency: external_exports.string().default("BRL")
});
var NormalizedDocumentJsonSchema = zodToJsonSchema(NormalizedDocumentSchema, "NormalizedDocument");
var InconsistencySchema = external_exports.object({
  code: nonEmptyString,
  message: nonEmptyString,
  explanation: nonEmptyString,
  normativeBase: external_exports.string().optional(),
  severity: external_exports.enum(["ERRO", "ALERTA", "INFO"])
});
var ClassificationSchema = external_exports.object({
  operationType: external_exports.enum(["Compra", "Venda", "Devolu\xE7\xE3o", "Servi\xE7o", "Transfer\xEAncia", "Outros"]),
  businessSector: nonEmptyString,
  confidence: external_exports.number().min(0).max(1)
});
var ClassificationJsonSchema = zodToJsonSchema(ClassificationSchema, "Classification");
var AuditedDocumentSchema = external_exports.object({
  doc: DocumentSchema,
  status: external_exports.enum(["OK", "ALERTA", "ERRO"]),
  score: external_exports.number().min(0).max(1).optional(),
  inconsistencies: external_exports.array(InconsistencySchema),
  classification: ClassificationSchema.optional()
});
var AccountingEntrySchema = external_exports.object({
  docId: nonEmptyString,
  docName: nonEmptyString,
  account: nonEmptyString,
  type: external_exports.enum(["D", "C"]),
  value: external_exports.number()
});
var TaxApportionSchema = external_exports.object({
  docId: nonEmptyString,
  taxType: external_exports.enum(["ICMS", "PIS", "COFINS", "ISS", "IPI", "OTHER"]),
  jurisdiction: nonEmptyString,
  basisAmount: external_exports.number(),
  taxAmount: external_exports.number(),
  confidence: external_exports.number().min(0).max(1),
  methodology: nonEmptyString
});
var TaxApportionJsonSchema = zodToJsonSchema(TaxApportionSchema, "TaxApportion");
var ReconIssueSchema = external_exports.object({
  code: nonEmptyString,
  description: nonEmptyString,
  severity: external_exports.enum(["INFO", "ALERTA", "CRITICO"]),
  references: external_exports.array(nonEmptyString).optional()
});
var ReconReportSchema = external_exports.object({
  docId: nonEmptyString,
  status: external_exports.enum(["OK", "ALERTA", "ERRO"]),
  reconciledAt: isoDateTime,
  issues: external_exports.array(ReconIssueSchema),
  summary: external_exports.string()
});
var ReconReportJsonSchema = zodToJsonSchema(ReconReportSchema, "ReconReport");
...
var LedgerEntryJsonSchema = zodToJsonSchema(LedgerEntrySchema, "LedgerEntry");
var AuditSummarySchema = external_exports.object({
  title: nonEmptyString,
  summary: nonEmptyString,
  keyMetrics: external_exports.array(
    external_exports.object({
      metric: nonEmptyString,
      value: external_exports.union([nonEmptyString, external_exports.number()]),
      insight: nonEmptyString
    })
  ),
  actionableInsights: external_exports.array(nonEmptyString),
  strategicRecommendations: external_exports.array(nonEmptyString).optional()
});
var AIFindingSchema = external_exports.object({
  category: external_exports.enum(["Efici\xEAncia Operacional", "Risco Fiscal", "Oportunidade de Otimiza\xE7\xE3o", "Anomalia de Dados"]),
  description: nonEmptyString,
  severity: external_exports.enum(["INFO", "BAIXA", "M\xC9DIA", "ALTA"]),
  evidence: external_exports.array(nonEmptyString)
});
var CrossValidationResultSchema = external_exports.object({
...
var DeterministicDiscrepancySchema = external_exports.object({
  valueA: external_exports.union([nonEmptyString, external_exports.number()]),
  docA: external_exports.object({
    name: nonEmptyString,
    internalPath: external_exports.string().optional()
  }),
  valueB: external_exports.union([nonEmptyString, external_exports.number()]),
  docB: external_exports.object({
    name: nonEmptyString,
    internalPath: external_exports.string().optional()
  })
});
var DeterministicCrossValidationSchema = external_exports.object({
  comparisonKey: nonEmptyString,
  attribute: nonEmptyString,
  description: nonEmptyString,
  discrepancies: external_exports.array(DeterministicDiscrepancySchema),
  severity: external_exports.enum(["ALERTA", "INFO"])
});
var AuditReportSchema = external_exports.object({
  traceId: nonEmptyString,
  docId: nonEmptyString,
  summary: AuditSummarySchema,
  documents: external_exports.array(AuditedDocumentSchema),
  aggregatedMetrics: external_exports.record(nonEmptyString, external_exports.union([nonEmptyString, external_exports.number()])).optional(),
  accountingEntries: external_exports.array(AccountingEntrySchema).optional(),
  ledgerEntries: external_exports.array(LedgerEntrySchema).optional(),
  taxApportion: external_exports.array(TaxApportionSchema).optional(),
  reconReport: ReconReportSchema.optional(),
  aiDrivenInsights: external_exports.array(AIFindingSchema).optional(),
  crossValidationResults: external_exports.array(CrossValidationResultSchema).optional(),
  deterministicCrossValidation: external_exports.array(DeterministicCrossValidationSchema).optional(),
  generatedAt: isoDateTime
});
var AuditReportJsonSchema = zodToJsonSchema(AuditReportSchema, "AuditReport");
var ClassificationCorrectionSchema = external_exports.object({
  docName: nonEmptyString,
  operationType: ClassificationSchema.shape.operationType
});

// ../packages/agents/src/a0-planner/index.ts
var PlannerPayloadSchema = external_exports.object({
  ...
  options: external_exports.object({
    ...
    reprocess: external_exports.boolean().default(false),
...
var PlannerAgent = {
  ...
  async handle(input, context2) {
    ...
    for (const document of payload.documents) {
      ...
      const hasLock = await context2.locks.acquire(lockKey, 60);
      if (!hasLock) {
        skipped += 1;
        continue;
      }
      ...
      await context2.enqueue(message);
      enqueued += 1;
    }
    await Promise.all(
      locksAcquired.map((lock) => context2.locks.release(lock).catch((error3) => context2.logger.warn("Failed to release lock", { lock, error: error3 })))
    );
...
// ../packages/agents/src/a1-ingestor/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var IngestPayloadSchema = DocumentSchema;
var PARSER_VERSION = "ingestor/v1";
var IngestorAgent = {
  id: "A1",
  ...
  async handle(input, context2) {
    ...
    const alreadyProcessed = await context2.kv.get(idempotencyKey);
    if (alreadyProcessed) {
      context2.logger.info("Skipping ingest due to idempotency hit", { docId: document.docId });
      return {
    ...
    await context2.kv.put(idempotencyKey, parsed, 60 * 60);
    const headers = {
      traceId: input.traceId,
      docId: document.docId,
...
// ../packages/agents/src/a2-ocr-parser/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var NormalizerInputSchema = ParsedDocumentSchema;
var OcrParserAgent = {
  id: "A2",
  ...
  async handle(input, context2) {
    ...
    const normalizedLines = (parsedDoc.structuredData ?? []).map(
      (row, index) => NormalizedLineSchema.parse({
        lineId: row.lineId,
...
// ../packages/agents/src/a3-normalizer/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../packages/agents/src/a4-auditor/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var AuditorAgent = {
  ...
  async handle(input, context2) {
    ...
    const audit = AuditReportSchema.parse({
      ...
      summary: {
        title: `Relat\xF3rio ${normalized.doc.name}`,
        summary: `Documento ${normalized.doc.name} processado com ${documentCount} linhas normalizadas.`,
        keyMetrics: [
          {
            metric: "Linhas Normalizadas",
            value: documentCount,
            insight: "Quantidade total de linhas estruturadas ap\xF3s a normaliza\xE7\xE3o."
          }
        ],
        actionableInsights: [],
...
// ../packages/agents/src/a5-classifier/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var DEFAULT_CONFIDENCE = 0.8;
var selectClassification = /* @__PURE__ */ __name((report2) => {
  const sector = report2.documents[0]?.doc.meta?.tags?.[0] ?? "Desconhecido";
  return {
...
var ClassifierAgent = {
  ...
  async handle(input, context2) {
    const startedAt = Date.now();
    const payload = external_exports.object({ audit: AuditReportSchema }).parse(input.payload);
...
// ../packages/agents/src/a6-ledger/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var ClassificationReadySchema = external_exports.object({
  audit: AuditReportSchema,
  classification: external_exports.object({
    operationType: external_exports.string(),
    businessSector: external_exports.string(),
...
var LedgerAgent = {
  ...
  async handle(input, context2) {
    ...
    const ledgerEntries = payload.audit.documents.map(
      (doc, index) => LedgerEntrySchema.parse({
        docId: doc.doc.docId,
    ...
    const taxApportion = payload.audit.documents.map(
      (doc) => TaxApportionSchema.parse({
        docId: doc.doc.docId,
        taxType: "ICMS",
        jurisdiction: "BR",
        basisAmount: 0,
    ...
    await Promise.all([context2.enqueue(ledgerMessage), context2.enqueue(taxMessage)]);
    return {
      traceId: input.traceId,
      docId: payload.audit.docId,
...
// ../packages/agents/src/a7-reconciliation/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var TaxReadySchema = external_exports.object({
  audit: AuditReportSchema,
  taxApportion: external_exports.array(TaxApportionSchema)
});
var ReconciliationAgent = {
  id: "A7",
  ...
  async handle(input, context2) {
    ...
    const recon = ReconReportSchema.parse({
      ...
      issues: [],
      summary: "Reconciliado com base nos lan\xE7amentos cont\xE1beis e apropria\xE7\xE3o tribut\xE1ria."
    });
    const headers = {
      traceId: input.traceId,
      docId: payload.audit.docId,
...
// ../packages/agents/src/a8-reporting/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var ReconDoneSchema = external_exports.object({
  audit: AuditReportSchema,
...
var ReportingAgent = {
  ...
  async handle(input, context2) {
    ...
    await context2.kv.put(`report:${payload.audit.docId}`, finalReport, 7 * 24 * 60 * 60);
    const jobKey = `job:${payload.audit.traceId}`;
    const existingJob = await context2.kv.get(jobKey);
    await context2.kv.put(jobKey, {
      ...existingJob ?? {},
      status: "report_ready",
...
// ../packages/agents/src/a9-assistant/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var ReportReadySchema = external_exports.object({
  audit: AuditReportSchema
});
var AssistantAgent = {
  id: "A9",
  ...
  async handle(input, context2) {
    ...
    await context2.kv.put(`assistant:${payload.audit.docId}`, knowledgeBase, 24 * 60 * 60);
    const headers = {
      traceId: input.traceId,
      docId: payload.audit.docId,
...
// ../packages/agents/src/a10-observability/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var AssistantReadySchema = external_exports.object({
  audit: AuditReportSchema,
  knowledgeBase: external_exports.object({
    docId: external_exports.string(),
    embeddingsVersion: external_exports.string(),
    preparedAt: external_exports.string()
  })
});
var ObservabilityAgent = {
  id: "A10",
  ...
  async handle(input, context2) {
    ...
    context2.telemetry.recordMetric("pipeline.finalized", 1, {
      docId: payload.audit.docId
    });
    context2.logger.info("Pipeline finalized", {
      docId: payload.audit.docId,
...
var log3 = /* @__PURE__ */ __name((level, source, message, attributes) => {
  const payload = { message, source, attributes, ts: (/* @__PURE__ */ new Date()).toISOString() };
  switch (level) {
    case "DEBUG":
...
var createLogger = /* @__PURE__ */ __name((source) => ({
  debug: /* @__PURE__ */ __name((message, attributes) => log3("DEBUG", source, message, attributes), "debug"),
  info: /* @__PURE__ */ __name((message, attributes) => log3("INFO", source, message, attributes), "info"),
  warn: /* @__PURE__ */ __name((message, attributes) => log3("WARN", source, message, attributes), "warn"),
  error: /* @__PURE__ */ __name((message, attributes) => log3("ERROR", source, message, attributes), "error")
}), "createLogger");
var createTelemetry = /* @__PURE__ */ __name((instrumentationName) => {
  const tracer = import_api.trace.getTracer(instrumentationName);
  return {
    async startSpan(name, fn, attributes) {
      ...
      try {
        ...
        span.setStatus({ code: import_api.SpanStatusCode.ERROR, message: error3 instanceof Error ? error3.message : "unknown error" });
    ...
    recordException(error3, attributes) {
      import_api.diag.error("Agent exception", { error: error3, attributes });
    },
    recordMetric(name, value, attributes) {
      import_api.diag.info("Metric", { name, value, attributes });
    }
  };
}, "createTelemetry");
...
var ingestRequestSchema = external_exports.object({
  ...
  source: external_exports.enum(["upload", "api", "backfill"]).default("upload"),
  documents: external_exports.array(
    external_exports.object({
  ...
  options: external_exports.object({
    ...
    reprocess: external_exports.boolean().optional(),
    dryRun: external_exports.boolean().optional()
  }).optional()
});
var assistantRequestSchema = external_exports.object({
  docId: external_exports.string().min(1),
  query: external_exports.string().min(1),
  scope: external_exports.enum(["summary", "ledger", "tax", "full"]).default("full")
});
var agentRegistry = {
...
var detectKind = /* @__PURE__ */ __name((mimeType) => {
...
var toDocument = /* @__PURE__ */ __name((tenantId, source, input) => {
...
var createKvAdapter = /* @__PURE__ */ __name((namespace) => ({
  async get(key) {
    const value = await namespace.get(key, "json");
    return value ?? null;
  },
  async put(key, value, ttlSeconds) {
    await namespace.put(key, JSON.stringify(value), ttlSeconds ? { expirationTtl: ttlSeconds } : void 0);
  },
  async delete(key) {
    await namespace.delete(key);
  }
}), "createKvAdapter");
var createLockAdapter = /* @__PURE__ */ __name((namespace) => ({
...
var getQueueBinding = /* @__PURE__ */ __name((env2, queueName) => {
  const bindingKey = QUEUE_BINDING_BY_TOPIC[queueName];
  return env2[bindingKey];
}, "getQueueBinding");
var dispatchEvent = /* @__PURE__ */ __name(async (env2, event) => {
  const queueName = EVENT_TOPIC[event.name];
  const queue = getQueueBinding(env2, queueName);
  await queue.sendBatch([{ body: JSON.stringify(event) }]);
}, "dispatchEvent");
var runAgent = /* @__PURE__ */ __name(async (agent, event, env2, ctx) => {
  const logger = createLogger(agent.id);
  const telemetry = createTelemetry(`agent-${agent.id}`);
  const kvStore = createKvAdapter(env2.KV_STATE);
  const lockManager = createLockAdapter(env2.KV_LOCKS);
  const agentInput = {
  ...
  const agentContext = {
    env: env2,
    enqueue: /* @__PURE__ */ __name((message) => dispatchEvent(env2, message), "enqueue"),
    kv: kvStore,
    locks: lockManager,
    telemetry,
    logger
...
var parseMessageBody = /* @__PURE__ */ __name((body) => {
  if (!body) return null;
...
var createQueueHandler = /* @__PURE__ */ __name((queueName) => ({
  async queue(batch, env2, ctx) {
    for (const message of batch.messages) {
      try {
        ...
        await runAgent(agent, parsed, env2, ctx);
      } catch (error3) {
        console.error(`[queue:${queueName}] handler failed`, error3);
        message.retry();
      }
    }
  }
}), "createQueueHandler");
var ingestQueue = createQueueHandler("q.ingest");
var parseQueue = createQueueHandler("q.parse");
var normalizeQueue = createQueueHandler("q.normalize");
var auditQueue = createQueueHandler("q.audit");
var classifyQueue = createQueueHandler("q.classify");
var ledgerQueue = createQueueHandler("q.ledger");
var taxQueue = createQueueHandler("q.tax");
var reconQueue = createQueueHandler("q.recon");
var reportQueue = createQueueHandler("q.report");
var observabilityQueue = createQueueHandler("q.observability");
var getJson = /* @__PURE__ */ __name(async (request, schema) => {
  const json = await request.json();
  return schema.parse(json);
}, "getJson");
var handleIngest = /* @__PURE__ */ __name(async (request, env2) => {
  ...
  await dispatchEvent(env2, event);
  await env2.KV_STATE.put(`job:${jobId}`, JSON.stringify({
    jobId,
    tenantId: payload.tenantId,
    status: "scheduled",
...
var handleGetReport = /* @__PURE__ */ __name(async (docId, env2) => {
  const record = await env2.KV_STATE.get(`report:${docId}`, "json");
  if (!record) {
...
var handleAssistant = /* @__PURE__ */ __name(async (request, env2) => {
  const payload = await getJson(request, assistantRequestSchema);
  const knowledge = await env2.KV_STATE.get(`assistant:${payload.docId}`, "json");
  const report2 = await env2.KV_STATE.get(`report:${payload.docId}`, "json");
  if (!report2) {
...
var src_default = {
  async fetch(request, env2, ctx) {
    ...
    try {
      ...
      console.error("Worker fetch error", error3);
  ...
  async queue(batch, env2, ctx) {
    for (const message of batch.messages) {
      try {
        ...
        console.error("[queue] handler failed", error3);
        message.retry();
      }
    }
  }
